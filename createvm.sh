...
VBoxManage createmedium disk --filename /sgoinfre/goinfre/Perso/mabouce/$vmname.vdi --size $vmsize --variant Fixed
echo "\n $_GREEN--------------------------------------------------------------------------------$_DEF\n"

echo "\nSETTING UP SATA CONTROLLER\n"
VBoxManage storagectl $vmname --name "SATA Controller" --add sata --controller IntelAhci
VBoxManage storageattach $vmname --storagectl "SATA Controller" --port 0 --device 0 --type hdd --medium /sgoinfre/goinfre/Perso/mabouce/$vmname.vdi
echo "\n $_GREEN--------------------------------------------------------------------------------$_DEF\n"
